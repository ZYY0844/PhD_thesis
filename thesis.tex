...
% \fancyheadoffset[RE,LO]{0.1\textwidth}
...
\begin{figure}[tb]
        \centering
        \subfloat[]{\label{fig:radar_good}\includegraphics[width=0.25\columnwidth]{radar_good.eps}}
        \subfloat[]{\label{fig:radar_bad}\includegraphics[width=0.25\columnwidth]{radar_bad.eps}}
        \subfloat[]{\label{fig:org_scen}\includegraphics[width=0.25\columnwidth]{org_scen.eps}}
        \subfloat[]{\label{fig:cardi_good}\includegraphics[width=0.25\columnwidth]{cardi_good.eps}}
...
\begin{figure}[tb]
  \centering
  \subfloat[]{\label{fig:target_org}\includegraphics[width=0.25\columnwidth]{target_org.eps}}
  \subfloat[]{\label{fig:target_sig}\includegraphics[width=0.25\columnwidth]{target_sig.eps}} 
  \subfloat[]{\label{fig:target_org_bad}\includegraphics[width=0.25\columnwidth]{target_org_bad.eps}}
  \subfloat[]{\label{fig:target_sig_bad}\includegraphics[width=0.25\columnwidth]{target_sig_bad.eps}}
...
\begin{figure}[tb]
  \centering
  \subfloat[]{\label{fig:pk_err_point}\includegraphics[width=0.4\columnwidth]{pk_err_point.eps}}
  \subfloat[]{\label{fig:pk_mdr_point}\includegraphics[width=0.39\columnwidth]{pk_mdr_point.eps}} \\
  \subfloat[]{\label{fig:pk_err_cdf}\includegraphics[width=0.4\columnwidth]{pk_err_cdf.eps}}
  \subfloat[]{\label{fig:pk_mdr_cdf}\includegraphics[width=0.4\columnwidth]{pk_mdr_cdf.eps}} 
...
\begin{figure}[tb]
  \centering
  \subfloat[]{\label{fig:radar_clean}\includegraphics[width=0.25\columnwidth]{radar_clean.eps}}
  \subfloat[]{\label{fig:ecg_pred_clean}\includegraphics[width=0.25\columnwidth]{ecg_pred_clean.eps}} \\
  \subfloat[]{\label{fig:radar_noise}\includegraphics[width=0.25\columnwidth]{radar_noise.eps}}
  \subfloat[]{\label{fig:ecg_pred_noise}\includegraphics[width=0.25\columnwidth]{ecg_pred_noise.eps}} 
...
\begin{figure}[tb]
  \centering
  \subfloat[]{\label{fig:fs_bad}\includegraphics[width=0.3\columnwidth]{fs_bad.eps}}
  \subfloat[]{\label{fig:fs_good}\includegraphics[width=0.3\columnwidth]{fs_good.eps}}
