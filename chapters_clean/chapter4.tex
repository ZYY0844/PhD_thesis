\glsresetall
\chapter{Robust Single-Cycle ECG Recovery}\label{ch:radarODE}
...
\subsubsection{Single-cycle ECG Generator}\label{sec:sceg}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.75\columnwidth]{peak_cdf.pdf}
  \caption{\textcolor{black}{CDF of the overall timing error, with overall improvement for each peak as: Q: 4\%, R: 15\%, S: 5\%, T: 9\%}}\label{fig:peak_cdf}
