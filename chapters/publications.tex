...
\begin{enumerate}
    ...
    \item \textbf{Yuanyuan Zhang}, Haocheng Zhao, Sijie Xiong, Rui Yang, Eng Gee Lim, Yutao Yue, "From High-SNR Radar Signal to ECG: A Transfer Learning Model with Cardio-Focusing Algorithm for Scenarios with Limited Data", \textit{\textbf{IEEE Transactions on Instrumentation and Measurement}}. (Under Review)
