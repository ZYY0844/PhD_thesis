...
\begin{figure}[tb]
        \centering
        \subfloat[]{\label{fig:radar_good}\includegraphics[width=0.3\columnwidth]{radar_good.eps}}
        \subfloat[]{\label{fig:radar_bad}\includegraphics[width=0.3\columnwidth]{radar_bad.eps}} 
        \caption{Challenges for radar-based ECG recovery: (a) and (b) Radar signals with high and low SNR for adjacent points with a distance of $0.03$m.}
...
\subsection{Experimental Details}\label{sec:cftdata_coll}
...
\begin{figure}[tb]
  \centering
  \subfloat[]{\label{fig:radar_clean}\includegraphics[width=0.35\columnwidth]{radar_clean.eps}}
  \subfloat[]{\label{fig:ecg_pred_clean}\includegraphics[width=0.35\columnwidth]{ecg_pred_clean.eps}} \\
  \subfloat[]{\label{fig:radar_noise}\includegraphics[width=0.35\columnwidth]{radar_noise.eps}}
  \subfloat[]{\label{fig:ecg_pred_noise}\includegraphics[width=0.35\columnwidth]{ecg_pred_noise.eps}} 
